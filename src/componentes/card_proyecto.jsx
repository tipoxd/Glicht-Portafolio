      ...
      >
        ...
        <div className="relative w-full h-full px-4 sm:px-6 lg:px-4 flex justify-center items-center">
          <h3 className="text-center">
            <a className="text-white text-2xl font-bold text-center group-hover:hidden" href="#">
              <span className="absolute inset-0" ></span>
              {data.Titulo}
            </a>
            <a className="text-white text-2xl font-bold text-center hidden group-hover:block transition-all" href="#">
              <span className="absolute inset-0" ></span>
              {data.Descripcion}
            </a>
          </h3>
